    ...
    <section className="py-20 bg-gray-section">
      <div className="container px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <Card className="p-6 relative bg-white text-orange-500 border-2 border-orange-500 scale-105">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-orange-500/80 mb-4">Best value for local students</p>
              <div className="mb-4">
                <span className="text-4xl font-bold">£1,250</span>
                <span className="text-orange-500/80"> /cohort</span>
              </div>
              <Button 
            ...
            <div className="space-y-3">
              {includes.map((item, index) => (
                <div key={index} className="flex items-start gap-2 text-sm">
                  ...
                  <span className="text-orange-500/90">{item}</span>
                </div>
              ))}
            </div>
          </Card>
