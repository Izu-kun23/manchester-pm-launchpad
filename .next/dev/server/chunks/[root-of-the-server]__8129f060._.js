...
"[project]/Desktop/Desktop Folder/manchester-pm-launchpad/lib/mailerlite.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function updateSubscriberGroup(email, firstName, groupId) {
    const apiKey = process.env.MAILERLITE_API_KEY;
    if (!apiKey) {
        return {
            success: false,
    ...
    try {
        ...
        const addToGroupResponse = await fetch(`https://connect.mailerlite.com/api/groups/${groupId}/subscribers`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${apiKey}`
        ...
        const updateResponse = await fetch(`https://connect.mailerlite.com/api/subscribers/${subscriberData.data.id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${apiKey}`
        ...
        if (!updateResponse.ok) {
            ...
            return {
                success: false,
                error: errorData.message || errorData.errors?.[0]?.message || 'Failed to update subscriber'
            };
        }
        return {
            success: true
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Desktop__Folder$2f$manchester$2d$pm$2d$launchpad$2f$lib$2f$mailerlite$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Desktop Folder/manchester-pm-launchpad/lib/mailerlite.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8129f060._.js.map